...
class _$SuccessImpl<S, F> implements Success<S, F> {
...
abstract class Success<S, F> implements Result<S, F> {
...
class _$FailureImpl<S, F> implements Failure<S, F> {
...
abstract class Failure<S, F> implements Result<S, F> {
